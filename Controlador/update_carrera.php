...
if(isset($_POST['submit']) && !empty($_POST['nombre_carrera'])){
        ...
        if($sql){
            ...
            echo"<script type=\"text/javascript\">alert('Se actualizo correctamente'); window.location='../index.php';</script>";

        }else{
            //mensaje de salida en caso de que la consulta falle
            echo"<script type=\"text/javascript\">alert('Se produjo un error'); window.location='../gestion_carrera.php';</script>";
        }
