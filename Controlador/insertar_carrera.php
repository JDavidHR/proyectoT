...
if(isset($_POST['submit']) && !empty($_POST['nombre_carrera'])){
        ...
        $sql=$mysql->efectuarConsulta("insert into asistencia.carrera(nombre,estado) VALUES ('".$carrera."',1)");
        ...
        if($sql){
            ...
            echo"<script type=\"text/javascript\">alert('Se produjo un error'); window.location='../registro_carrera.php';</script>";
        }
