<?php
    ...
    $sql = $mysql->efectuarConsulta("UPDATE asistencia.carrera SET estado = 1 WHERE id_carrera = ".$id_carrera."");
    ...
    if($sql){
        ...
        echo"<script type=\"text/javascript\">alert('Se activo correctamente'); window.location='../../gestion_carrera.php';</script>";
        //echo $estudiante;
    }else{
